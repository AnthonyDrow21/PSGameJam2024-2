...
var ITEMS = {
	...
	"journalpage_aquaregia_hint1": ItemDefClass.instantiate().with_data("journalpage_aquaregia_hint1", "Torn Journal Page", "A ripped journal page with some kind of ... alchemical symbols?", "aqua_regia_recipe", "res://Assets/Sounds/JournalPageTurn.wav", "res://Assets/Items/Clues/AquaRegiaHintImage.png"),
	"journalpage_aquaregia_hint2": ItemDefClass.instantiate().with_data("journalpage_aquaregia_hint2", "Torn Journal Page", "A ripped journal page with some kind of ... alchemical symbols?", "aqua_regia_recipe", "res://Assets/Sounds/JournalPageTurn.wav", "res://Assets/Items/Clues/AquaRegiaHintImage.png"),
	"journalpage_aquaregia_hint3": ItemDefClass.instantiate().with_data("journalpage_aquaregia_hint3", "Torn Journal Page", "A ripped journal page with some kind of ... alchemical symbols?", "aqua_regia_recipe", "res://Assets/Sounds/JournalPageTurn.wav", "res://Assets/Items/Clues/AquaRegiaHintImage.png"),
	"journalpage_aquaregia_hint4": ItemDefClass.instantiate().with_data("journalpage_aquaregia_hint4", "Torn Journal Page", "A ripped journal page with some kind of ... alchemical symbols?", "aqua_regia_recipe", "res://Assets/Sounds/JournalPageTurn.wav", "res://Assets/Items/Clues/AquaRegiaHintImage.png"),
