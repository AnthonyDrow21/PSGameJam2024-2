...
var ITEMS = {
	...
	"gold_goblet" : ItemDefClass.instantiate().with_data("gold_goblet", "Gold", "Looks shiny...", "gold", POTION_SOUND, "res://Assets/Items/Potions/GoldenChalice.png"),
	"water_bucket" : ItemDefClass.instantiate().with_data("water_bucket", "Bucket of Water", "Looks wet...", "water_bucket", POTION_SOUND, "res://Assets/Items/Potions/WaterBucket.png"),
